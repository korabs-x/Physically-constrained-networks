...
def mp_worker(data):
    ...
    for n_train in train_range:
        ...
        checkpoint_dir += 'm2_normed_det/'
        checkpoint_dir += 'dim-{}_normeddet-{}_ntrain-{}_seed-{}/'.format(
            fn_matrix_name, dim, n_train, train_seed)
        run_experiment(dim, n_train, train_seed, loss_fn, 0, checkpoint_dir, fn_matrix=fn_matrix, lr=5e-5,
                       iterations=50000, n_test=4096, model_class=NetConnected100)
